          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              >
                ...
                <span className="text-primary-foreground text-sm font-medium">Natural Language to SQL Conversion</span>
              </motion.div>
              ...
              >
                An AI-driven platform that transforms natural language queries into SQL statements. 
                Automate database interactions, reduce query complexity, and enable non-technical users 
                to access data with Generative AI and cloud-based services.
              </motion.p>
